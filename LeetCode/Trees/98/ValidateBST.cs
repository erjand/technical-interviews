...
// If the recursive call makes it to the base call where the node is null, then we know it successfully traversed an entire path of the tree with no constraint violations.
